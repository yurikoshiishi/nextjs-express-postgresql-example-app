...
const GoogleIcon = () => {
  return (
    <svg viewBox="0 0 128 128" className="google-icon">
      <defs>
        <style
          dangerouslySetInnerHTML={{
            __html:
              '.google-icon .cls-1{fill:#fff;}.google-icon .cls-2{fill:#e33629;}.google-icon .cls-3{fill:#f8bd00;}.google-icon .cls-4{fill:#587dbd;}.google-icon .cls-5{fill:#319f43;}',
          }}
        />
      </defs>
      <title>google</title>
