...
interface EndUserAgreementProps {
  [key: string]: any;
}

const EndUserAgreement: React.FC<EndUserAgreementProps> = (props) => {
  const title = '利用規約';
  ...
  return (
    <SidebarLayout title={title} description={description}>
      <Article title={title}>
        <section>
          <p>
            この利用規約（以下，「本規約」といいます。）は，PReview運営事務局（以下，「当事務局」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
          </p>
        </section>
        <section>
          <Typography variant="h2">第1条（適用）</Typography>
          <p>
        ...
        <section>
          ...
          <p>
            本サービスでは、レビュー投稿などのサービス利用のために、Google、Facebook、Twitterといった外部サービスによるログインを提供しています。
          </p>
          <p>
            ユーザーは，自己の責任において，本サービスのユーザーアカウントを適切に管理するものとします。
          </p>
          <p>
            ユーザーアカウントが第三者によって使用されたことによって生じた損害は，当事務局に故意又は重大な過失がある場合を除き，当事務局は一切の責任を負わないものとします。
          </p>
        </section>
        <section>
          <Typography variant="h2">第3条（禁止事項）</Typography>
          <p>
        ...
        <section>
          <Typography variant="h2">第5条（利用制限および登録抹消）</Typography>
          <p>
        ...
        <section>
          <Typography variant="h2">第6条（退会）</Typography>
          <p>
        ...
        <section>
          <Typography variant="h2">第11条（通知または連絡）</Typography>
          <p>
        ...
        <section>
          <Typography variant="h2">第12条（権利義務の譲渡の禁止）</Typography>
          <p>
            ユーザーは，当事務局の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
          </p>
        </section>
        <section>
          <Typography variant="h2">第13条（準拠法・裁判管轄）</Typography>
